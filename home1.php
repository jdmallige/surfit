...
{   $sqlll="update levels set participants=participants+1 where no=$level ";
       $ress=mysqli_query($dbc,$sqlll);
    echo "correct answer";
...
<head>
    ...
    <a id=logo href="index.php"><img src="img/1logo.jpg" id=logo ></a>
    <ul>
   ...
   <br><br>
    ...
    <div id="img">
         ...
         <h1><?php echo $clue;?> </h1>
        <img  style="height:400px;width:500px;"src="img/<?php echo $level.".jpg";?>">    
